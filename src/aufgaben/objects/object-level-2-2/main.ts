...
singers.sort((singerA: Singer, singerB: Singer) => singerA.name.localeCompare(singerB.name))

console.log(singers)

singers.sort((singerA: Singer, singerB: Singer) => singerA.period_active.start - singerB.period_active.start)
