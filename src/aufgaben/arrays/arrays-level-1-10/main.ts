...
const splittedString1: string[] = futuramaQuote.split(".")
const splittedString2: string[] = futuramaQuote.split(" ")
const splittedString3: string[] = futuramaQuote.split("")

console.log(splittedString1)
console.log(splittedString2)
console.log(splittedString3)
